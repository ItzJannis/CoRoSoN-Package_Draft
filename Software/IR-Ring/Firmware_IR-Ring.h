...
#define BLUR_ORIGINAL_VALUE_WEIGHT_PERCENTAGE (30) // ! keep inside ]0;100] 
...
#define VECTOR_ADDITION_SENSOR_COUNT (NUM_SENSORS * EXPAND_FACTOR_PER_SENSOR / 6) // ! keep inside [1;NUM_SENSORS * EXPAND_FACTOR_PER_SENSOR]
